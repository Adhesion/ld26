...
BossChunk.prototype.build = function() {
    this.items = [
        ...
        {time:1.0, action:function(game){
            game.bossAppear(new THREE.Vector3(0, 1000, 300))
		...
		{time:5.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(0,500,0), 5, 4) ) } },
		{time:6.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(0,500,0), 5, 1) ) } },
		{time:7.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(0,500,0), 5, 14) ) } },

		{time:8.0, action:function(game){ game.bossMove(new THREE.Vector3(-200, 500, 0)) } },
		...
		{time:12.0, action:function(game){ game.bossMove(new THREE.Vector3(200, 500, 0)) } },
		...
		{time:13.0, action:function(game){ game.makeLinkedBaddies( [
            new Baddie(new THREE.Vector3(210,500,0), 5, 0),
            new Baddie(new THREE.Vector3(200,550,0), 5, 2),
